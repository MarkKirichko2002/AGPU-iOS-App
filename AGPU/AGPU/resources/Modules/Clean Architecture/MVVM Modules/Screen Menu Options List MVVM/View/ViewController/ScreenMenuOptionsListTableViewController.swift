//
//  ScreenMenuOptionsListTableViewController.swift
//  AGPU
//
...
protocol ScreenMenuOptionsListTableViewControllerDelegate: AnyObject {
    func listWasUpdated()
}

final class ScreenMenuOptionsListTableViewController: UIViewController {
    ...
    // MARK: - сервисы
    private let viewModel: ScreenMenuOptionsListViewModel
    
    weak var delegate: ScreenMenuOptionsListTableViewControllerDelegate?
    
    init(screen: menuCategoryScreens) {
        self.viewModel = ScreenMenuOptionsListViewModel(screen: screen)
    ...
    func setUpNavigationTitle() {
        let titleView = CustomTitleView(image: "star", title: viewModel.screen.title, frame: .zero)
    ...
    @objc private func addButtonTapped() {
        let vc = AllScreenMenuOptionsListTableViewController(screen: viewModel.screen)
        vc.delegate = self
    ...
    private func bindViewModel() {
        viewModel.registerDataChangedHandler {
            ...
            self.delegate?.listWasUpdated()
        }
        viewModel.getOptions()
    }
}

// MARK: - AllScreenMenuOptionsListTableViewControllerDelegate
extension ScreenMenuOptionsListTableViewController: AllScreenMenuOptionsListTableViewControllerDelegate {
...
extension ScreenMenuOptionsListTableViewController: UITableViewDelegate {
...
extension ScreenMenuOptionsListTableViewController: UITableViewDataSource {
