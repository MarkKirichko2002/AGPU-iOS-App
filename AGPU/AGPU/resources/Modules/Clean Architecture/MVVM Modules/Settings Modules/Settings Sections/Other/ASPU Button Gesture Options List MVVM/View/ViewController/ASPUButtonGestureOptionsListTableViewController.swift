//
//  ASPUButtonGestureOptionsListTableViewController.swift
//  AGPU
//
...
final class ASPUButtonGestureOptionsListTableViewController: UITableViewController {

    // MARK: - сервисы
    private let viewModel = ASPUButtonGestureOptionsListViewModel()
