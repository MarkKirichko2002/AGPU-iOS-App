//
//  FuturisticWayOptionsListTableViewController.swift
//  AGPU
//
...
final class FuturisticWayOptionsListTableViewController: UITableViewController {
    
    var ways = futuristicWays.allCases
    ...
    private func setUpNavigation() {
        let titleView = CustomTitleView(image: "tech", title: "Способы управления", frame: .zero)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let vc = FuturisticWayScreenListTableViewController(way: ways[indexPath.row])
