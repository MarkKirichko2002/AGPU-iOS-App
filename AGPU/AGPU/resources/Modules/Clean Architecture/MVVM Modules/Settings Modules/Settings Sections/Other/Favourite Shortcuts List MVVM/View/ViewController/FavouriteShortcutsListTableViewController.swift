//
//  FavouriteShortcutsListTableViewController.swift
//  AGPU
//
...
final class FavouriteShortcutsListTableViewController: UIViewController {
    ...
    // MARK: - сервисы
    let viewModel = FavouriteShortcutsListViewModel()
    ...
    private func setUpNavigation() {
        ...
        let titleView = CustomTitleView(image: "star", title: "Шорткаты", frame: .zero)
    ...
    @objc private func addButtonTapped() {
        let vc = AllShortcutsListTableViewController()
        vc.delegate = self
    ...
    private func setUpLabel() {
        ...
        noActionsLabel.text = "Нет ярлыков"
    ...
    private func bindViewModel() {
        viewModel.registerDataChangedHandler {
            ...
            if !self.viewModel.shortcuts.isEmpty {
