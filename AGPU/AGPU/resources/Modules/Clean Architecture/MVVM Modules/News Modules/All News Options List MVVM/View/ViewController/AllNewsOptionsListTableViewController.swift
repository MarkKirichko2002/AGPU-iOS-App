//
//  AllNewsOptionsListTableViewController.swift
//  AGPU
//
...
final class AllNewsOptionsListTableViewController: UITableViewController {

    // MARK: - сервисы
    private let viewModel = AllNewsOptionsListViewModel()
    var selectedOptions = [NewsOptionModel]()
    ...
    private func setUpNavigation() {
        let titleView = CustomTitleView(image: "sections icon", title: "Список опций", frame: .zero)
