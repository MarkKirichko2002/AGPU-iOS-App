//
//  AllScreenMenuOptionsListTableViewController.swift
//  AGPU
//
...
protocol AllScreenMenuOptionsListTableViewControllerDelegate: AnyObject {
    func optionWasAdded()
}

final class AllScreenMenuOptionsListTableViewController: UITableViewController {

    // MARK: - сервисы
    private let viewModel: AllScreenMenuOptionsListViewModel
    var selectedOptions = [MenuOptionModel]()
    
    weak var delegate: AllScreenMenuOptionsListTableViewControllerDelegate?
    
    init(screen: menuCategoryScreens) {
        self.viewModel = AllScreenMenuOptionsListViewModel(screen: screen)
    ...
    private func setUpNavigation() {
        let titleView = CustomTitleView(image: "sections icon", title: viewModel.screen.title, frame: .zero)
