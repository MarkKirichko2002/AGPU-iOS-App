//
//  MenuOptionsListTableViewController.swift
//  AGPU
//
...
protocol MenuOptionsListTableViewControllerDelegate: AnyObject {
    func listWasUpdated()
}

final class MenuOptionsListTableViewController: UIViewController {
    ...
    // MARK: - сервисы
    private let viewModel: MenuOptionsListViewModel
    
    weak var delegate: MenuOptionsListTableViewControllerDelegate?
    
    init(category: menuOptionCategories) {
        self.viewModel = MenuOptionsListViewModel(category: category)
    ...
    func setUpNavigationTitle() {
        let titleView = CustomTitleView(image: "star", title: viewModel.category.title, frame: .zero)
    ...
    @objc private func addButtonTapped() {
        let vc = AllMenuOptionsListTableViewController(category: viewModel.category)
        vc.delegate = self
...
extension MenuOptionsListTableViewController: AllNewsOptionsListTableViewControllerDelegate {
...
extension MenuOptionsListTableViewController: UITableViewDelegate {
...
extension MenuOptionsListTableViewController: UITableViewDataSource {
