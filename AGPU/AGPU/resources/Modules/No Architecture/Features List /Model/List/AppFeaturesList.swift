...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 13,
            name: "Your TabBar",
            description: "Your TabBar (ваша панель вкладок) - позволяет настроить для панели вкладок: порядок вкладок, название для каждой вкладки и их действий, выбрать: действия для каждой вкладки и шрифт, вариант дополнительной вкладки, цвет для панели вкладок, стиль иконок, вариант вкладок включая сокращенные варианты (до 2 вкладок), включить/выключить: анимацию, сохранение недавней вкладки. Свайпы для панели: вправо - показать настройки для панели вкладок. Свайпы для вкладки: вверх - показать список действий для вкладки.",
