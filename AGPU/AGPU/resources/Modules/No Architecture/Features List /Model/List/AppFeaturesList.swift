...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 2,
            name: "Futuristic Way",
            description: "Futuristic Way (футуристичный способ) - голосовые команды или распознавание жестов руки для различных действий. Также вы можете выбрать на каком экране будет включаться микрофон или камера.",
