...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            ...
            description: "ASPU Wallpapers (АГПУ обои) - скачивайте обои, связанные с АГПУ.",
        ...
        AppFeatureModel(
            ...
            description: "Favourite Sections (избранные разделы) - список нужных разделов. Потяните для восстановления.",
        ...
        AppFeatureModel(
            id: 14,
            name: "Your TabBar",
            description: "Your TabBar (ваша панель вкладок) - позволяет настроить для панели вкладок: порядок вкладок, название для каждой вкладки (включая дополнительную), выбрать: действия для каждой вкладки, вариант дополнительной вкладки, цвет, шрифт, стиль иконок, вариант звуков, вариант вкладок включая сокращенные варианты (до 2 вкладок), включить/выключить: анимацию, сохранение недавней вкладки. Свайпы: влево - приглушить панель вкладок, вправо - показать панель вкладок.",
            videoURL: "https://youtu.be/pt8mm52DadA?si=9-vaD-eRBeWn5FZE"
        ),
