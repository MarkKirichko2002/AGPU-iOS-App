...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 17,
            name: "AR Mode",
            description: "AR Mode (AR режим) - позволяет просматривать объекты в дополненной реальности. Например, вы можете увидеть изображение расписания или сохранённое изображение в виде куба. Также у вас есть возможность выбрать форму или плоскость для объекта в AR. Помимо этого вы можете поделиться скриншотом.",
            videoURL: ""
        ),
