...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 18,
            name: "Pair Info",
            description: "Pair Info (информация о паре) - показывает время до начала/конца пары, расстояние до корпуса, время прибытия и позволяет скопировать информацию о паре.",
            videoURL: ""
        ),
