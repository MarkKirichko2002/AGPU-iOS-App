...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 15,
            name: "Visual Info",
            description: "Visual Info (визуальная информация) - показывает информацию за сегодня, например, вы будете знать, какие новости появились. Можно выбрать вариант отображения экрана: весь экран, лист, не показывать.",
            videoURL: ""
        ),
        ...
        AppFeatureModel(
            id: 16,
            name: "AR Mode",
            description: "AR Mode (AR режим) - позволяет просматривать изображения в AR, совершать навигацию между ними с помощью свайпов, голоса или использовать фонарик.",
            videoURL: ""
        ),
