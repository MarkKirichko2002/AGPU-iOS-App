...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 19,
            name: "Any Pseudonyms",
            description: "Any Pseudonyms (любые псевдонимы) - сделайте псевдоним для названия дня недели, времени, дисциплины, преподавателя, аудитории, группы, названия корпуса."
        )
    ]
}
