...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 2,
            name: "Different Ways",
            description: "Different Ways (различные способы) - голосовые команды, распознавание жестов руки, изменение уровня громкости, ориентации устройства для навигации. Также вы можете выбрать на каком экране их включать."
        ),
