//
//  MenuScreensCategoryTableViewCell.swift
//  AGPU
//
//  Created by Марк Киричко on 30.12.2025.
//

import UIKit
import SnapKit

final class MenuScreensCategoryTableViewCell: UITableViewCell {
    
    static let identifier = "MenuScreensCategoryTableViewCell"
    ...
    func configure(for category: MenuScreensCategoryModel) {
