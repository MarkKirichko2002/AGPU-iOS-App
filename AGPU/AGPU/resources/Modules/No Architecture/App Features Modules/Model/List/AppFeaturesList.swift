...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            ...
            description: "Important Things (важные вещи) - опция, которая позволяет сохранять, делиться и удалять документы, изображения а также видео. Кроме того, вы можете добавить документ или видео в список, введя его URL или добавить изображение в список из фото устройства.",
