...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 12,
            name: "Only Main",
            description: "Only Main (только главное) - сокращает количество вкладок с 4 до 2, оставляя только вкладки \"Расписание\" и \"Настройки\" или \"Новости\" и \"Настройки\". Включение этой опции позволяет сфокусироваться только на самом важном - вашем расписании занятий или на новостях.",
        ...
        AppFeatureModel(
            ...
            description: "Important Things (важные вещи) - опция, которая позволяет сохранять, делиться и удалять документы и изображения. Кроме того, вы можете добавить документ в список, введя его URL или добавить изображение в список из фото устройства.",
