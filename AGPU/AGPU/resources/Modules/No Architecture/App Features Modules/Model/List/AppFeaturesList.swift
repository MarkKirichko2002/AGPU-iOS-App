...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 1,
            name: "ASPU Button",
            description: "ASPU Button (АГПУ кнопка) – кнопка, расположенная в центре панели вкладок, автоматически изменяет изображение в зависимости от ваших действий. Также вы можете выбрать действие или иконку для этой кнопки."
        ),
