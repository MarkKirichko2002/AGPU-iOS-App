...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            ...
            description: "My Splash Screen (мой экран заставки) - выберите экран заставки приложения соответствующий вашим предпочтениям. Также вы можете сделать экран заставки со своим изображением, текстом и выбрать цвет. На данный момент доступно \(SplashScreenOptions.allCases.count) вариантов для экрана заставки."
        ),
