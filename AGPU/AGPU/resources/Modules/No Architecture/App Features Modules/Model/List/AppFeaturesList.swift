...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 10,
            name: "Smart Calendar",
            description: "Smart Calendar (умный календарь) - при выборе даты в календаре отображается информация о расписании. К тому же у вас есть возможность взаимодействовать со списком недавних дат. Также вы можете посмотреть расписание для нескольких одновременно выбранных дат в календаре.",
