...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 17,
            name: "AR Mode",
            description: "AR Mode (AR режим) - позволяет просматривать объекты в дополненной реальности. Например, вы можете увидеть изображение расписания или сохраненное изображение в виде куба.",
            videoURL: ""
        ),
    ]
}
