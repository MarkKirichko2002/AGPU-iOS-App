...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 1,
            name: "ASPU Button",
            description: "ASPU Button (АГПУ кнопка) - автоматически изменяет изображение на кнопке, находящейся в середине панели вкладок, в зависимости от ваших действий. Также вы можете выбрать действие для кнопки."
        ),
        ...
        AppFeatureModel(
            id: 6,
            name: "Adaptive News",
            description: "Adaptive News (адаптивные новости) - новости адаптируются в зависимости от выбранного факультета. При выборе факультета, вы получаете релевантные новости, связанные с вашим факультетом. При этом, вы также можете выбрать и сохранить другую категорию новостей на экране категорий или в настройках приложения. Кроме того, новости могут адаптироваться в соответствии с недавно просмотренной веб-страницей, данную опцию можно включить или выключить в настройках приложения. В дополнение, в настройках есть опция, которая при включении отображает новости только за сегодня или при выключении отображает все новости. Также у каждой новости сохраняется позиция, тем самым вы сможете продолжить читать с того места, где остановились. К тому же у вас есть возможность взаимодействовать со списком недавно прочитанных новостей."
        ),
        ...
        AppFeatureModel(
            id: 10,
            name: "Smart Calendar",
            description: "Smart Calendar (умный календарь) - функция, которая отображает информацию о расписании при выборе даты в календаре. Это помогает быстро организовать время и быть в курсе изменений в расписании."
        ),
        ...
        AppFeatureModel(
            ...
            description: "My Splash Screen (мой экран заставки) - выберите экран заставки приложения соответствующий вашим предпочтениям. Также вы можете сделать экран заставки со своим изображением и текстом. На данный момент доступно \(SplashScreenOptions.allCases.count) вариантов для экрана заставки."
        ),
        
        AppFeatureModel(
            id: 14,
            name: "Important Documents",
            description: "Important Documents (важные документы) - опция, которая позволяет сохранять, делиться и удалять документы. Это позволяет вам легко организовывать свои документы и иметь к ним доступ всегда, где бы вы ни находились."
        ),
        
        AppFeatureModel(
            id: 15,
            name: "Custom TabBar",
            description: "Custom TabBar (своя панель вкладок) - у вас есть возможность настроить панель вкладок по своему усмотрению. Например, вы можете изменить порядок вкладок."
        ),
    ]
}
