...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            ...
            description: "Important Documents (важные документы) - опция, позволяющая сохранять, редактировать, делиться и удалять документы. С легкостью организуйте свои документы и имейте к ним доступ всегда, где бы вы ни находились."
        ),
