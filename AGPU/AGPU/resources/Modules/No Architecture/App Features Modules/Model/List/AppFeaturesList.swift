...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            ...
            description: "Important Documents (важные документы) - опция, которая позволяет сохранять, делиться и удалять документы. Кроме того, у вас есть возможность добавить документ в список после ввода его URL. Это позволяет вам легко организовывать свои документы и иметь к ним доступ всегда, где бы вы ни находились."
        ),
