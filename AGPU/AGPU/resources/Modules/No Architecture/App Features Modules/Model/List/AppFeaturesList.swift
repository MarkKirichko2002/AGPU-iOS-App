...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            ...
            description: "Important Things (важные вещи) - опция, которая позволяет сохранять, делиться и удалять документами и изображениями. Кроме того, вы можете добавить документ в список, введя его URL."
        ),
