...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 9,
            name: "Revolutionary Timetable",
            description: "Revolutionary Timetable (революционное расписание) - опция, позволяющая получить расписание на основе выбранной группы, аудитории или преподавателя. Она позволяет выбрать неделю из списка, автоматически прокрутиться до нужной недели, дня недели и группы, а также предоставляет информацию о том, в каком корпусе будут проходить занятия. Дополнительно имеется голосовая прокрутка до дня недели в расписание. Кроме того, вы можете отфильтровать пары по типу, чтобы быстро и удобно получить доступ к интересующим вас занятиям. Также у вас есть возможность поделиться расписанием на день или неделю в виде изображения или сохранить изображение расписания в фото вашего устройства. В дополнение к этому, данная функция предоставляет информацию о времени, оставшемся до начала или конца пары. Вместе с тем вы можете взаимодействовать со списком \"Избранное\". Помимо этого у вас есть возможность просматривать расписание в дополненной реальности.",
