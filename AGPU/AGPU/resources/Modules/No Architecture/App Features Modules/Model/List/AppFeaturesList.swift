...
struct AppFeaturesList {
    ...
    static let features = [
        ...
        AppFeatureModel(
            id: 1,
            name: "ASPU Button",
            description: "ASPU Button (АГПУ кнопка) – кнопка, расположенная в центре панели вкладок, автоматически изменяет изображение в зависимости от ваших действий. Также вы можете выбрать действие, иконку или анимацию для этой кнопки."
        ),
        ...
        AppFeatureModel(
            id: 15,
            name: "Custom TabBar",
            description: "Custom TabBar (своя панель вкладок) - у вас есть возможность настроить панель вкладок по своему усмотрению. Например, вы можете изменить порядок вкладок или включить/выключить анимацию для них."
        ),
    ]
}
