//
//  SimpleSettingsViewController.swift
//  AGPU
//
...
final class SimpleSettingsViewController: UIViewController {
    ...
    private func setUpView() {
        ...
        titleLabel.text = "Хотите вернуться в продвинутый режим приложения?"
        okButton.addTarget(self, action: #selector(goBackToAdvancedMode), for: .touchUpInside)
    }
